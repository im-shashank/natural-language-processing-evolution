...
class TransformerDecoderLayer(nn.Module):
    ...
    def forward(self, x, encoder_output, tgt_mask=None, tgt_pad_mask=None, memory_mask=None, memory_pad_mask=None):
        ...
        # 2. Cross Attention: memory_mask keeps it causal so a position can't read future
        #    context from the encoder, memory_pad_mask handles the encoder's padding.
        attn_output, _ = self.crossed_mha(x, encoder_output, encoder_output, attn_mask=memory_mask, key_padding_mask=memory_pad_mask)
